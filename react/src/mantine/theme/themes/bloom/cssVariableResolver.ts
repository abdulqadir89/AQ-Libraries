...
export const shadcnCssVariableResolver: CSSVariablesResolver = () => ({
    variables: {
        ...
        '--mantine-primary-color-light': 'var(--mantine-color-bloom-light)',
        '--mantine-primary-color-light-hover': 'var(--mantine-color-bloom-light-hover)',
        '--mantine-primary-color-light-color': 'var(--mantine-color-bloom-light-color)',
    },
    light: {
        '--mantine-primary-color-contrast': '#fff',
        '--mantine-color-text': 'var(--mantine-color-secondary-9)',
        '--mantine-color-body': 'var(--mantine-color-bloom-0)',
        ...
        // Light peach sidebar CSS variables — always active under bloom theme
        '--els-navbar-bg': '#ffe3d9',
        '--els-navbar-border': 'rgba(92,64,56,0.14)',
        '--els-navbar-text': '#5c4038',
        '--els-navbar-text-muted': 'rgba(92,64,56,0.55)',
        '--els-navbar-active': '#ff8b7a',
        '--els-navbar-active-color': '#ffffff',

        // filled colors
        "--mantine-color-bloom-filled": "var(--mantine-color-bloom-5)",
        "--mantine-color-bloom-filled-hover": alpha('var(--mantine-color-bloom-5)', 0.9),
        ...
        // light colors
        "--mantine-color-bloom-light": alpha('var(--mantine-color-bloom-4)', 0.14),
        "--mantine-color-bloom-light-hover": alpha('var(--mantine-color-bloom-light)', 0.8),
        "--mantine-color-bloom-light-color": "var(--mantine-color-bloom-7)",
        ...
        // outline colors
        "--mantine-color-bloom-outline": "var(--mantine-color-bloom-5)",
        "--mantine-color-bloom-outline-hover": alpha('var(--mantine-color-bloom-4)', 0.1),
        ...
        // contrast colors
        "--mantine-color-bloom-contrast": "#fff",
    ...
    dark: {
        '--mantine-primary-color-contrast': '#2b2230',
        '--mantine-color-text': 'var(--mantine-color-secondary-0)',
        '--mantine-color-body': '#2b2230',
        '--mantine-color-error': 'var(--mantine-color-error-10)',
        '--mantine-color-placeholder': 'var(--mantine-color-secondary-4)',
        '--mantine-color-anchor': 'var(--mantine-color-secondary-4)',

        '--mantine-color-default': '#382d3f',
        '--mantine-color-default-hover': '#4a3c52',
        '--mantine-color-default-color': 'var(--mantine-color-secondary-1)',
        '--mantine-color-default-border': '#4a3c52',
        '--mantine-color-dimmed': 'var(--mantine-color-secondary-4)',

        '--mantine-color-secondary-filled': '#382d3f',
        '--mantine-color-secondary-filled-hover': alpha('var(--mantine-color-secondary-filled)', 0.9),

        '--mantine-color-secondary-light': '#4a3c52',
        '--mantine-color-secondary-light-hover': alpha('var(--mantine-color-secondary-light)', 0.8),

        '--mantine-color-secondary-text': 'var(--mantine-primary-color-contrast)',
        '--mantine-color-secondary-light-color': 'var(--mantine-color-secondary-0)',

        '--mantine-color-secondary-outline': '#4a3c52',
        '--mantine-color-secondary-outline-hover': '#4a3c52',

        // Dark peach-tinted sidebar
        '--els-navbar-bg': '#241c2b',
        '--els-navbar-border': 'rgba(243,227,234,0.1)',
        '--els-navbar-text': '#f3e3ea',
        '--els-navbar-text-muted': 'rgba(243,227,234,0.55)',
        '--els-navbar-active': '#ff9c8c',
        '--els-navbar-active-color': '#2b2230',

        // filled colors (dark mode)
        "--mantine-color-bloom-filled": "var(--mantine-color-bloom-4)",
        "--mantine-color-bloom-filled-hover": alpha('var(--mantine-color-bloom-4)', 0.9),
        ...
        // light colors (dark mode)
        "--mantine-color-bloom-light": alpha('var(--mantine-color-bloom-4)', 0.16),
        "--mantine-color-bloom-light-hover": alpha('var(--mantine-color-bloom-light)', 0.8),
        "--mantine-color-bloom-light-color": "var(--mantine-color-bloom-3)",
        ...
        "--mantine-color-bloom-outline": "var(--mantine-color-bloom-4)",
        "--mantine-color-bloom-outline-hover": alpha('var(--mantine-color-bloom-4)', 0.15),
        ...
        // contrast colors (dark mode)
        "--mantine-color-bloom-contrast": "#2b2230",
