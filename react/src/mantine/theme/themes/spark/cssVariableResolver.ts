...
export const shadcnCssVariableResolver: CSSVariablesResolver = () => ({
    variables: {
        ...
        '--mantine-primary-color-light': 'var(--mantine-color-spark-light)',
        '--mantine-primary-color-light-hover': 'var(--mantine-color-spark-light-hover)',
        '--mantine-primary-color-light-color': 'var(--mantine-color-spark-light-color)',
        // Deep indigo sidebar CSS variables — always active under spark theme
        '--els-navbar-bg': '#150e2c',
        '--els-navbar-border': '#2b2440',
        '--els-navbar-text': '#e4dbff',
        '--els-navbar-text-muted': 'rgba(228,219,255,0.5)',
    },
    light: {
        '--mantine-primary-color-contrast': 'var(--mantine-color-spark-0)',
        '--mantine-color-text': 'var(--mantine-color-secondary-9)',
        '--mantine-color-body': 'var(--mantine-color-spark-0)',
        ...
        // filled colors
        "--mantine-color-spark-filled": "var(--mantine-color-spark-5)",
        "--mantine-color-spark-filled-hover": alpha('var(--mantine-color-spark-5)', 0.9),
        ...
        // light colors
        "--mantine-color-spark-light": alpha('var(--mantine-color-spark-4)', 0.12),
        "--mantine-color-spark-light-hover": alpha('var(--mantine-color-spark-light)', 0.8),
        "--mantine-color-spark-light-color": "var(--mantine-color-spark-6)",
        ...
        // outline colors
        "--mantine-color-spark-outline": "var(--mantine-color-spark-5)",
        "--mantine-color-spark-outline-hover": alpha('var(--mantine-color-spark-4)', 0.1),
        ...
        // contrast colors
        "--mantine-color-spark-contrast": "var(--mantine-color-spark-0)",
    ...
    dark: {
        '--mantine-primary-color-contrast': '#1a1030',
        ...
        "--mantine-color-spark-filled": "var(--mantine-color-spark-4)",
        "--mantine-color-spark-filled-hover": alpha('var(--mantine-color-spark-4)', 0.9),
        ...
        "--mantine-color-spark-light": alpha('var(--mantine-color-spark-4)', 0.18),
        "--mantine-color-spark-light-hover": alpha('var(--mantine-color-spark-light)', 0.8),
        "--mantine-color-spark-light-color": "var(--mantine-color-spark-3)",
        ...
        "--mantine-color-spark-outline": "var(--mantine-color-spark-4)",
        "--mantine-color-spark-outline-hover": alpha('var(--mantine-color-spark-4)', 0.15),
        ...
        "--mantine-color-spark-contrast": "#1a1030",
