...
export const shadcnCssVariableResolver: CSSVariablesResolver = () => ({
    ...
    dark: {
        ...
        '--mantine-color-default': 'var(--mantine-color-secondary-8)', // used as default surface color
        ...
        '--mantine-color-default-border': 'var(--mantine-color-secondary-6)', // used as default border color
