...
export const shadcnCssVariableResolver: CSSVariablesResolver = () => ({
    variables: {
        '--mantine-heading-font-weight': '500',
        '--mantine-primary-color-filled-hover': alpha('var(--mantine-primary-color-filled)', 0.9),
        '--mantine-primary-color-light': 'var(--mantine-color-steel-light)',
        '--mantine-primary-color-light-hover': 'var(--mantine-color-steel-light-hover)',
        '--mantine-primary-color-light-color': 'var(--mantine-color-steel-light-color)',
        // Deep charcoal-navy sidebar — always active under steel theme
        '--els-navbar-bg': '#16212e',
        '--els-navbar-border': '#243040',
        '--els-navbar-text': '#e4e9ef',
        '--els-navbar-text-muted': 'rgba(228,233,239,0.5)',
    },
    light: {
        '--mantine-primary-color-contrast': '#fff',
        '--mantine-color-text': 'var(--mantine-color-secondary-9)',
        '--mantine-color-body': 'var(--mantine-color-steel-0)',
        ...
        // filled colors
        "--mantine-color-steel-filled": "var(--mantine-color-steel-5)",
        "--mantine-color-steel-filled-hover": alpha('var(--mantine-color-steel-5)', 0.9),
        ...
        // light colors
        "--mantine-color-steel-light": alpha('var(--mantine-color-steel-4)', 0.12),
        "--mantine-color-steel-light-hover": alpha('var(--mantine-color-steel-light)', 0.8),
        "--mantine-color-steel-light-color": "var(--mantine-color-steel-7)",
        ...
        // outline colors
        "--mantine-color-steel-outline": "var(--mantine-color-steel-5)",
        "--mantine-color-steel-outline-hover": alpha('var(--mantine-color-steel-4)', 0.1),
        ...
        // contrast colors
        "--mantine-color-steel-contrast": "#fff",
    ...
    dark: {
        '--mantine-primary-color-contrast': '#0d131a',
        '--mantine-color-text': 'var(--mantine-color-secondary-0)',
        '--mantine-color-body': '#131b24',
        '--mantine-color-error': 'var(--mantine-color-error-10)',
        '--mantine-color-placeholder': 'var(--mantine-color-secondary-4)',
        '--mantine-color-anchor': 'var(--mantine-color-secondary-4)',

        '--mantine-color-default': '#1a232e',
        '--mantine-color-default-hover': '#243040',
        '--mantine-color-default-color': 'var(--mantine-color-secondary-1)',
        '--mantine-color-default-border': '#2b3746',
        '--mantine-color-dimmed': 'var(--mantine-color-secondary-4)',

        '--mantine-color-secondary-filled': '#1a232e',
        '--mantine-color-secondary-filled-hover': alpha('var(--mantine-color-secondary-filled)', 0.9),

        '--mantine-color-secondary-light': '#243040',
        '--mantine-color-secondary-light-hover': alpha('var(--mantine-color-secondary-light)', 0.8),

        '--mantine-color-secondary-text': 'var(--mantine-primary-color-contrast)',
        '--mantine-color-secondary-light-color': 'var(--mantine-color-secondary-0)',

        '--mantine-color-secondary-outline': '#2b3746',
        '--mantine-color-secondary-outline-hover': '#2b3746',

        // filled colors (dark mode)
        "--mantine-color-steel-filled": "var(--mantine-color-steel-4)",
        "--mantine-color-steel-filled-hover": alpha('var(--mantine-color-steel-4)', 0.9),
        ...
        "--mantine-color-steel-light": alpha('var(--mantine-color-steel-4)', 0.16),
        "--mantine-color-steel-light-hover": alpha('var(--mantine-color-steel-light)', 0.8),
        "--mantine-color-steel-light-color": "var(--mantine-color-steel-3)",
        ...
        "--mantine-color-steel-outline": "var(--mantine-color-steel-4)",
        "--mantine-color-steel-outline-hover": alpha('var(--mantine-color-steel-4)', 0.15),
        ...
        "--mantine-color-steel-contrast": "#0d131a",
